...
class EpistemicAdvantageModel:
    def __init__(self):
        ...
        self.objective_b = 0.51 # actual probability of B arm yielding success, alternates between .51, .55, .6, .7, .8
    ...
    def timestep(self):
        ...
        for _node, node_data in self.graph.nodes(data=True):
            ...
            # agent pulls the "b" bandit arm
                ...
                node_data['b_evidence'] = int(np.random.binomial(self.num_pulls, self.objective_b, size=None))
